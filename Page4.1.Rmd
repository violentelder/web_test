...
很多时候，ui文件没有被Designer直接打开，可能是由于其打开方式没有关联到Designer上，需要按照一下步骤进行操作：
 ...
 ![](https://img-blog.csdnimg.cn/20201023221107183.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzU2MDQ4OQ==,size_16,color_FFFFFF,t_70#pic_center)
 
 - **点击添加按钮，添加Designer到打开方式中**（路径通常在\Qt\Qt5.7.0\5.7\msvc2015_64\bin下）
 
 
 ![](https://img-blog.csdnimg.cn/20201023221245623.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MzU2MDQ4OQ==,size_16,color_FFFFFF,t_70#pic_center)
